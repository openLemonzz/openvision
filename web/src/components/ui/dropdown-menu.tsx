...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-2.5 py-1.5 text-[10px] font-medium uppercase tracking-[0.14em] text-[#c7c7c7] data-[inset]:pl-8",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-white/8 -mx-1 my-1 h-px", className)}
      {...props}
    />
  )
}
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[10px] tracking-[0.18em] text-[#b4b4b4]",
        className
      )}
      {...props}
    />
