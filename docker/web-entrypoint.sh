...
ADMIN_API_URL_ESCAPED="$(escape_json "${VITE_ADMIN_API_URL:-}")"
ADMIN_APP_URL_ESCAPED="$(escape_json "${VITE_ADMIN_APP_URL:-}")"
...
window.__APP_CONFIG__ = {
  ...
  VITE_ADMIN_API_URL: "${ADMIN_API_URL_ESCAPED}",
  VITE_ADMIN_APP_URL: "${ADMIN_APP_URL_ESCAPED}"
};
EOF
